...
For example "studio name.", "room number or name.", "floor plan number or name." and so on. You can Add tags to Connections, Surfaces, Positions and just about any part of Buttons, to group them together or use the tag in search or filters. 
